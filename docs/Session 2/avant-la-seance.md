# Séance 2 — Avant la séance

**Préparation de :** [Séance 2 — Mettre les concepts en pratique](formation_photo_session_2.md)

> Ce fichier couvre uniquement ce qu'il faut faire **avant** d'entrer dans la salle. Le déroulé minuté est dans [formation_photo_session_2.md](formation_photo_session_2.md), et le suivi dans [apres-la-seance.md](apres-la-seance.md).
