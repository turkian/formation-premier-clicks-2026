...
> On ne parle jamais plus de 20 minutes sans que les appareils sortent des sacs.

Chaque bloc théorique est suivi d'un **« appareil en main »** de 4 à 6 minutes. L'objectif de ces moments n'est pas de faire une belle photo : c'est de **localiser physiquement le réglage** sur son propre appareil. Un débutant qui sait où est le bouton n'a plus peur du concept.
...
## 0:00–0:12 — Accueil et tour de table éclair

### Ce que tu dis en ouverture

Trois messages, dans cet ordre :

1. **Il n'y a aucune question bête ici.** La photo est pleine de vocabulaire inutilement compliqué. Si un mot n'est pas clair, arrête-moi.
...
Pas de bloc « lexique ». Les mots seront définis au moment où on en a besoin. Le lexique complet est au verso de la carte aide-mémoire, pour ceux qui veulent le relire à la maison.
...
2. **Qu'est-ce qui doit être net?**
3. **Comment est-ce que je veux représenter le mouvement?**
4. **Quelle lumière ai-je à ma disposition?**

### Ce qu'il faut faire comprendre

L'appareil en mode automatique répond à ces quatre questions **à ta place**, et il y répond mal, parce qu'il ne sait pas ce que tu veux montrer. Sortir du mode automatique, ce n'est pas devenir technique : c'est reprendre ces quatre décisions.

Toute la séance consiste à traiter ces questions une par une.
...
- Beaucoup / peu de lumière
- Conséquence pratique : la quantité de lumière **limite** tes choix. Elle ne les dicte pas.
...
- Dure / douce
- **La taille apparente de la source** décide de tout : une petite source = ombres tranchées, une grande source = ombres douces. Un ciel couvert est une source géante, donc douce.

### Couleur

Très légèrement :

- Lumière chaude / froide
- Balance des blancs : *« l'appareil essaie de deviner quelle est la couleur du blanc dans la scène. Parfois il se trompe. »*

### Démonstration — la fenêtre

Même sujet, quatre positions par rapport à une fenêtre. Projette les quatre côte à côte.

**La phrase à dire :** *« Je n'ai touché à aucun réglage. J'ai bougé de deux pas. C'est le geste le plus rentable de toute la photographie. »*

### Appareil en main — 3 min

Consigne unique : **prends deux photos du même objet sur ta table, en te déplaçant pour que la lumière vienne d'un côté différent.** Regarde la différence sur ton écran.

Aucun réglage. C'est volontaire — le premier geste de la formation ne demande aucune technique, et tout le monde réussit.
...
### La distinction à poser d'abord

- **La mise au point**, c'est *où* l'appareil fait le point. Un seul endroit.
- **La profondeur de champ**, c'est *l'épaisseur* de la zone qui paraît nette autour de cet endroit.

On règle la première maintenant, la seconde au bloc suivant.

### Autofocus

- Ce que fait réellement l'autofocus : il fait le point sur **ce que tu lui désignes** — et si tu ne désignes rien, il choisit tout seul, généralement ce qui est le plus près ou le plus contrasté.
- Choix du point de mise au point
- Zone AF (large / zone / collimateur unique)
- Détection du visage et des yeux

### Modes autofocus

- **AF-S / Single / One Shot** — le sujet ne bouge pas. Le point est fait, puis verrouillé.
...
Projette une photo ratée (idéalement une des tiennes). Demande au groupe :

- Où l'appareil a-t-il fait le point?
- Où le photographe voulait-il faire le point?

C'est le premier exercice de **diagnostic** de la formation. Il reviendra à chaque séance.

### Démonstration

Portrait, trois versions : point sur l'œil, point sur l'oreille, point sur l'arrière-plan. Projette les trois.

### Appareil en main — 6 min

Trois gestes, dans l'ordre. Les animateurs circulent.

1. **Trouve ton sélecteur de zone AF** et mets-le sur un collimateur unique (ou « zone flexible », selon les marques).
2. **Déplace le collimateur** (pavé directionnel, joystick, ou écran tactile sur les sans-miroir).
3. **Fais le point sur un objet précis** de ta table, puis vérifie sur l'écran que c'est bien lui qui est net.

> **Cellulaire :** touche l'écran à l'endroit où tu veux le point. Un petit carré apparaît. C'est exactement le même geste.

> **Sans-miroir :** active la détection de l'œil si ton appareil l'a. C'est probablement la meilleure fonction de ta génération d'appareils, et beaucoup de gens ne l'allument jamais.
...
> **Reflex :** tu ne verras pas l'effet dans le viseur (il montre toujours la pleine ouverture). Regarde l'écran après la photo. C'est normal.
...
Tu as trois démonstrations dans cette séance. Une démo que la moitié de la salle ne voit pas est **pire** que pas de démo : elle crée de l'exclusion.

- **Plan A :** appareil relié au projecteur (HDMI ou tethering)
- **Plan B, souvent meilleur :** images préparées à l'avance et projetées côte à côte. Tu contrôles la comparaison, rien ne peut échouer, et tu gagnes du temps.

Prépare le plan B même si tu comptes sur le plan A.

### Gérer 30 personnes pendant les manipulations

- Annonce la consigne **avant** que les appareils sortent. Une fois qu'ils sont sortis, personne n'écoute.
- Donne un signal de fin sonore (pas ta voix).
- Les animateurs circulent et **ne prennent jamais l'appareil des mains** de quelqu'un. Le geste doit être fait par la personne, sinon elle ne le refera pas chez elle.
- Accepte de laisser 2-3 personnes en retard sur un réglage exotique. Note leur modèle et règle ça à la pause.

### Vocabulaire à surveiller
